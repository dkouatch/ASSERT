...
class GeosReport(EarthSystemsReport):
    ...
    def set_subject(self) -> str:
        """
        GEOS implementation of set_subject()
    ...
    def set_addresses(self) -> list[str]:
        """
        GEOS implementation of set_addresses()
    ...
    def set_html(self) -> bool:
        """
        GEOS implementation of set_html()
    ...
    def set_header(self) -> list[str]:
        """
        GEOS implementation of set_header()
    ...
    def set_legend(self) -> dict[str, str]:
        """
        GEOS implementation of set_legend()
    ...
    def interpret_test(self, res: Any) -> str:
        """
        GEOS implementation of interpret_test()
    ...
    def add_test_report(self) -> None:
        """
        GEOS implementation of add_test_report()

        """
        logger.info('GEOS — Test results added to report.')

    def send_report(self, end_time: dt.datetime) -> str:
        """
        GEOS implementation of send_report()
...
"""
        ...
        logger.notice('GEOS — Report Complete.')
        return self.report
